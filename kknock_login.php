...
<html lang="en">
    ...
    <body>
        ...
        <small><a href="kknock_join.php">처음 오셨나요?</a><small>
        <?php } else {
            $user_id = $_SESSION['user_id'];
            $user_name = $_SESSION['user_name'];
            echo "<p>$user_name($user_id)님은 이미 로그인되어 있습니다.";
            echo "<p><button onclick=\"window.location.href='kknock_main.php'\">메인으로</button> <button onclick=\"window.location.href='kknock_logout.php'\">로그아웃</button></p>";
        } ?>
    </body>
</html>