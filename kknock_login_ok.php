<?php
    ...
    if($res){
        ...
        echo "window.location.replace('kknock_main.php');</script>";
        exit;
    }
    else{
       echo "<script>alert('아이디 혹은 비밀번호가 잘못되었습니다.');";
       echo "window.location.replace('kknock_login.php');</script>";
    }
?>
<meta http-equiv="refresh" content="0;url=kknock_main.php">